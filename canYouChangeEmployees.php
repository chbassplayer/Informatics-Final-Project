...
if (isset($_POST['submit'])) {
   ...
   // connect to the database
    ...
    $query = "SELECT employees FROM employees WHERE id=$empID;";
    $result = queryDB($query, $db);
    if (nTuples($result) > 0) {
        // then that account number exists
		$row =nextTuple($result);
        $answer = $row['employees'];
        $_SESSION['AccessEmployees']="yes";
        ...
        // wrong password
        punt("Access Denied. <a href='canYouChangeEmployees.php'>Try again</a>.");
        }
    }
}
?>
...
<!-- Visible title -->
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="canYouChangeEmployees.php" method="post">
                <!-- ID -->
